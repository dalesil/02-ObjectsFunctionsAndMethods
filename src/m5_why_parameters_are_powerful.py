...
def main():
    ...
    #better_draw_circles(rg.Point(200, 300), 10)
    #better_draw_circles(rg.Point(-100, 200), 20)

    #even_better_draw_circles(rg.Point(-100, 0), 30, 10, 'green', 3)
    #even_better_draw_circles(rg.Point(100, 0), 15, 10, 'red', 8)

    even_better_draw_circles(rg.Point(0, 0), 30, 10, 'black', 1)
    even_better_draw_circles(rg.Point(0, 0), 15, 10, 'red', 8)
...
def even_better_draw_circles(point, increase, circles, color, thickness):
